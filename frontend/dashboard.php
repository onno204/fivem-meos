...
<nav class="nav-links">
		<a href=""><img class="back" src="img/pijllinks.png" alt="Italian Trulli"></a>
		...
		<a href="instellingen.php"><p class="uitloggen-nav"><i class="fas fa-sign-out-alt"></i>  Uitloggen</p></a>
</nav>
